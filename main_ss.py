...
def save_results(first_eval,tr_hist,num_classes,sub,split,n_ds,n_ch,T):
    ...
    results_str = '/content/eegnet-based-embedded-bci/results/stats/ss_class_{num_classes}_ds{n_ds}_nch{n_ch}_T{T}_sub{sub_str}_split_{split}.csv'
...
global_model_path = '/content/eegnet-based-embedded-bci/results/model/'
# Make necessary directories for files
results_dir='/content/eegnet-based-embedded-bci/results'
